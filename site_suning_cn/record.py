...
def data_record(data):
    """
    """
    store_item_id = MySQLdb.string_literal(data['item_id'])
    ...
    rec_sql_template = "insert into item_from_suning (`store_item_id`,`item_brand`,`item_model`,`store_title`,`store_desc`, \
    `store_adv`, `store_price`, `item_url`, `item_thumb`, `item_category`, `item_property`, `_created`, `_updated`) values (%s, '%s', '%s', %s, %s, %s, \
